...
import "./Login.css"
import { changeInstructor, changeIsLoggedIn, changeRole, changeStudent, changeToken, changeUser, usePostLoginMutation } from "../../GlobalStore/GlobalStore"
        ...
        if (!postLoginResponse.isLoading && !postLoginResponse.isUninitialized) {
            if (postLoginResponse.isError) {
                ...
                setTimeout(() => {
                    ...
                    if (postLoginResponse.data.user.role === 'instructor') {
    ...
    return <div className="login-container">
        <div className="main-content">
            ...
            <div className="intro-text">
                <h1>Examiner - Students Portal</h1>
            ...
            <div className="form">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="password">
                        ...
                        <Link style={{ color: 'red' }} to="/student/forget-password">Forget password?</Link>
                    </div>
