...
function Signup() {
    ...
    function handleSignup(e) {
        ...
        setIsLoading(true)
        postSignup({ email: email, password: password, tel: tel, role: 'instructor', username: username })
    }
    ...
    function handleRedirect(e) {
        e.preventDefault()        
        window.location.href = process.env.REACT_APP_PUBLIC_URL_STUDENT
    }
        ...
        <div className="main-content">
            <form onSubmit={handleSignup} className="signup-form">
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <button name="account_type" className="add-answer-btn" style={{ backgroundColor: '#007bff', color: 'white' }} onClick={(e) => handleRedirect(e)}>Go to Student Portal </button>
                </div>
