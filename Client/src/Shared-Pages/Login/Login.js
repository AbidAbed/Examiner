...
import "./Login.css"
import { changeInstructor, changeIsLoggedIn, changeRole, changeToken, changeUser, usePostLoginMutation } from "../../GlobalStore/GlobalStore"
            ...
            <div className="form">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="password">
                        ...
                        <Link style={{ color: 'red' }} to="/forget-password">Forget password?</Link>
                    </div>
