...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to handle adding/removing active className
    function setActiveClass(event) {
        // Remove the active className from all list items
        listItems.forEach(item => item.classList.remove('active'));
        
        // Add the active className to the clicked item
    ...
    // Check the URL hash and add the active className to the correct list item
    ...
    // Set active className on the currently active section when the page loads
